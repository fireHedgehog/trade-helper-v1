"""Run Fed put: yield-stress precursor v2.

Usage (from backend/):
    python -m app.run_fed_put_yield_stress_precursor_v2

Implements docs/research-protocols/fed-put-yield-stress-precursor-v2.md.
Amends v1 (closed not_evaluable) with a fuller, action-based episode
inventory -- same score, same machinery. Thesis Track evidence-layer
output only (not_evaluable / weak_evidence / evidence_present) -- no
trade, no Stage 9B authorization, no signal.
"""
...
SPEC_PATH = ROOT / "research/experiments/fed-put-yield-stress-precursor-v2.json"
SPEC_SHA256 = "59ef27791a68e7750848b772c070196d403c739d9539efd12f8f4d9e0d7e6e5f"
...
def main() -> None:
    ...
    output = ROOT / "output/research/fed-put-yield-stress-precursor-v2" / SPEC_SHA256
    _atomic_json(
