"""Run the Wave Pull v1 impulse-pullback vs. plain-breakout-placebo experiment.

Usage (from backend/):
    python -m app.run_wave_pull

Implements docs/research-protocols/wave-pull-v1.md. This is a no-trade event
study and significance test; it may output only material_and_consistent /
...
from .research import holm_adjust, wave_pull_bootstrap
from .run_experiment import _atomic_json
from .store import load_bars

ROOT = Path(__file__).parents[2]
SPEC_PATH = ROOT / "research/experiments/wave-pull-v1.json"
SPEC_SHA256 = "618a482ae4866887d13b38d84679a98b7343fe2e4e983e29ead6a249f49050c1"
...
def run_bootstrap(spec: dict, bars_by_symbol: dict) -> dict:
    ...
    for symbol in order:
        ...
        per_asset[symbol] = wave_pull_bootstrap(
            closes,
...
def main() -> None:
    ...
    output = ROOT / "output/research/wave-pull-v1" / SPEC_SHA256
    _atomic_json(
