...
Status: non-contract leaf. Not evidence, not a decision, not product documentation. Zero acceptance weight. Loaded only on explicit author request ("recall brainstorm …"); not scanned by default.

Purpose: idea-generation record upstream of the machine. A memo grants nothing; an idea becomes a candidate only via exploration-protocol → Stage 9A → preregistration. No grandfathering.
