...
| Can a Chapter 4 ensemble be long-short, and how is it constructed (alpha model, risk model, optimizer)? | [ADR 0010 (proposed)](adr/0010-long-short-ensemble-construction.md) |
