...
| Verification | `289 passed` at `0.56.0` (calibration study is a standalone diagnostic script, not part of the pytest suite); `0.58.0` is docs-only, no code touched |
