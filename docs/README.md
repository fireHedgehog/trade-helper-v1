...
| Current state | Single-asset/time-series line **parked**; Fed put (Cycle 6) now closed too — see below. Both new engines proven (`app.macro_pit`; cross-sectional bootstrap `N=12→495`); [Thesis Track](thesis-track-small-n.md) (`app.thesis_track`) got its first real use. No active research line remains chosen |
| Verification | `332 passed` at `0.65.0` |
| Completed | Stage 8; Stage 9A Cycles 1–6; CTA v1/v2; TA Breakout, Wave Pull, ETF-12 rotation, both calendar candidates, Overnight Gap, Fed put yield-stress precursor — all closed and indexed in [research-protocols/README.md](research-protocols/README.md) |
| Next product work | No queued research task. Fed put closed [`not_evaluable`](research-results/fed-put-yield-stress-precursor-v1.md) (`p=0.989`, decisively opposite-signed, 4/4 real QE episodes) — a follow-up needs a new, independently-justified mechanism, not a retry. Next line is undecided again: 6-variable [macro library](brainstorm/2026-08-20-macro-reaction-function-narrative-library.md) (idea-stage), [cross-sectional](brainstorm/2026-08-20-cross-sectional-experiment-ideas.md) (Tier 4, unpurchased), [policy-exposure factor](brainstorm/2026-08-20-policy-exposure-industrial-factor.md) (idea-stage) are the live options — run [next-priority-evaluation.md](next-priority-evaluation.md) before picking. `S/R Bounce`, MACD, Elliott Wave remain separately parked — see [pending checklist](brainstorm/2026-08-19-pending-candidate-checklist.md) |
| Active research | None. Fed put closed this cycle; see stage-closures precedent for whether this line (Fed/monetary-policy macro) should be formally parked too, or left open for a differently-motivated Fed candidate. Stage 9B remains gated |
