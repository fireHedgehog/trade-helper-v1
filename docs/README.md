...
| Active research | None active; ten closed results this session (nine technical/calendar/rotation candidates plus CTA v2) — the next step (Fed put's data/methodology investment, a reversal-framed follow-up, or a fresh cycle) is a deliberate choice, not a default; Stage 9B remains gated |
