...
| Current state | Single-asset/time-series line **parked**; Fed put (Cycle 6) now closed too, across two independent designs (v1 crisis-only, v2 adds real "not QE" actions) — see below. Both new engines proven; [Thesis Track](thesis-track-small-n.md) got two real uses. No active research line remains chosen |
| Verification | `332 passed` at `0.66.0` |
| Completed | Stage 8; Stage 9A Cycles 1–6; CTA v1/v2; TA Breakout, Wave Pull, ETF-12 rotation, both calendar candidates, Overnight Gap, Fed put yield-stress precursor v1+v2 — all closed and indexed in [research-protocols/README.md](research-protocols/README.md) |
| Next product work | No queued research task. Fed put closed [`not_evaluable`](research-results/fed-put-yield-stress-precursor-v2.md) twice (`p=0.989` n=4, `p=0.981` n=6 incl. the actual current episode) — a follow-up needs a new, independently-justified mechanism (e.g. a longer z-score lookback — a real, disclosed limitation v2 surfaced, not a same-design retry), not a retry. Next line undecided again: 6-variable [macro library](brainstorm/2026-08-20-macro-reaction-function-narrative-library.md), [cross-sectional](brainstorm/2026-08-20-cross-sectional-experiment-ideas.md) (Tier 4, unpurchased), [policy-exposure factor](brainstorm/2026-08-20-policy-exposure-industrial-factor.md) — all idea-stage, run [next-priority-evaluation.md](next-priority-evaluation.md) before picking. `S/R Bounce`, MACD, Elliott Wave remain separately parked — see [pending checklist](brainstorm/2026-08-19-pending-candidate-checklist.md) |
| Active research | None. Fed put closed this cycle; see stage-closures precedent for whether this line (Fed/monetary-policy macro) should be formally parked too, or left open for a differently-motivated Fed candidate (e.g. a longer-lookback design). Stage 9B remains gated |
