...
The roadmap is gate-based. Completion means evidence exists, not that code was written. Current checkpoint: `0.32.0`, Stage 8C in progress with one Stage 8D durability slice completed early.
