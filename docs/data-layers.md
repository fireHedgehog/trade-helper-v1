...
| Equity universe membership | [`universe.py`](../backend/app/universe.py) | built | no — today's constituents, survivorship-biased, disclosed | free (Wikipedia) | S&P 500 ∪ Nasdaq-100 ∪ XL sector ETFs, 495 in `bars` | Chapters 2/4 |
